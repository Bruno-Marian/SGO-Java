...
<body>
	...
	} else if (!UsuarioController.temPermissao(Permissoes.APENA_VISUALIZAR_TELAS_SOBRE_DOACAO) && !UsuarioController.temPermissao(Permissoes.TOTAL_TELAS_SOBRE_DOACAO)) {
