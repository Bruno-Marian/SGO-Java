...
<body>
	...
	} else if (!UsuarioController.temPermissao(Permissoes.APENAS_VISUALIZAR_TELAS_SOBRE_PERMISSAO_USUARIO) && !UsuarioController.temPermissao(Permissoes.TOTAL_TELAS_SOBRE_PERMISSAO_USUARIO)) {
